 ...
 * 
 * Modified to display moisture value on a web page
 * Werner Schollenberger
 * 
 * Note: You have to replace the variables "ssid" and "password" with
...
String moistureValue = "undefined";
...
void loop() {
  ...
  if (client) {                             // If a new client connects,
    ...
    Serial.println("Reading analog moisture value.");
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("<p>Moisture Sensor voltage: " + moistureString + "</p>");
